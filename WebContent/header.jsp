				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown"><a tabindex="-1" href="#"
						...
						<ul class="dropdown-menu">
							<li><a href="animalCare">Animal Care</a></li>
							<li class="divider"></li>
							<li><a href="addAnimal">Add Animal</a></li>
							<li><a href="feedingCare">Feeding Schedules</a></li>
							<li><a href="addFeeding">Add Feeding Schedule</a></li>
							<li><a href="assignFeeding">Assign Animal Feeding</a></li>
							
						</ul></li>
					<li class="dropdown"><a tabindex="-1" href="#"
						class="dropdown-toggle" data-toggle="dropdown">Event
